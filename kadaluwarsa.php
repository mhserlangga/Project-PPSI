...
if (isset($_GET['hapus'])) {
    $kodeobat = mysqli_real_escape_string($koneksi, $_GET['hapus']);
    $hapus = mysqli_query($koneksi, "DELETE FROM stock WHERE kodeobat = '$kodeobat'");
    ...
    // Redirect ulang biar URL bersih
    header("Location: kadaluwarsa.php");
    exit();
}
...
$today = date("Y-m-d");
$data = mysqli_query($koneksi, "SELECT * FROM stock WHERE kadaluwarsa < '$today'");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Obat Kadaluwarsa - Apotek Rakyat</title>
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-4">
            <h1 class="mt-4">Data Obat Kadaluwarsa</h1>
            <div class="card mb-4">
                <div class="card-header">
                    <i class="fas fa-calendar-times me-1"></i>
                    Obat yang sudah melewati tanggal kadaluwarsa (<?php echo $today; ?>)
                </div>
                <div class="card-body">
