...
<head>
    ...
    <title>Obat Masuk - Apotek Rakyat</title>
...
<div id="layoutSidenav">
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-4">
            <h1 class="mt-4">Data Obat Masuk</h1>
            <a href="tambahobat.php" class="btn btn-success mb-3">+ Tambah Obat</a>

            <div class="card mb-4">
                <div class="card-body">
                    <p>Data obat masuk untuk tanggal : <strong><?= $today ?></strong></p>
                        ...
                        <tbody>
                            <?php while ($d = mysqli_fetch_array($data)) { ?>
                                <tr>
                                    ...
                                    <td><?= $d['batchnumber']; ?></td>
                                    <td><?= $d['namaobat']; ?></td>
                                    <td><?= $d['namasupplier'] ? $d['namasupplier'] : '<em>Tidak ada</em>'; ?></td>
                                    <td><?= $d['stock']; ?></td>
                                    <td><?= $d['kadaluwarsa']; ?></td>
                                    ...
                                    <!-- Tombol Aksi -->
                                    <td>
                                        <a href="hapus.php?id=<?= $d['kodeobat']; ?>" 
                                        onclick="return confirm('Yakin ingin menghapus data ini?')" 
                                        class="btn btn-danger btn-sm">
                                            <i class="fas fa-trash-alt"></i>
                                        </a>

                                        <a href="edit.php?kodeobat=<?= $d['kodeobat']; ?>" 
