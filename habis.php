...
if (isset($_GET['hapus'])) {
    ...
    // ✅ Redirect balik ke halaman habis.php
    header("Location: habis.php");
    exit();
}

// Ambil data obat habis
$data = mysqli_query($koneksi, "SELECT * FROM stock WHERE stock = 0");
?>
<!DOCTYPE html>
<html lang="en">
<head>
    ...
    <title>Obat Habis - Apotek Rakyat</title>
    ...
    <div id="layoutSidenav_content">
        <main class="container-fluid px-4">
            ...
            <div class="card-header">
                    ...
                    Obat yang sudah habis, harus segera dibeli!
                </div>
                <div class="card-body">
                        ...
                        <tbody>
                            <?php while ($d = mysqli_fetch_array($data)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        <a href="habis.php?hapus=<?= $d['kodeobat']; ?>" 
